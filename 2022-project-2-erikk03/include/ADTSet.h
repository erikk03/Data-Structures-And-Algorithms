...
// Η συνάρτηση αυτή δημιουργεί ένα set, το οποίο περιέχει τα στοιχεία του vector values,
// τα οποία πρέπει να δίνονται ταξινομημένα σε αύξουσα σειρά
